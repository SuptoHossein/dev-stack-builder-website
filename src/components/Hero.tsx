...
const Hero = () => {
  return (
    <div className="container mx-auto flex justify-between items-center my-13">
      <div className="flex flex-col space-y-10">
        ...
        <div className="flex gap-3">
          <button className="bg-linear-to-r from-[#FE5525] via-[#B925A3] to-[#8038E7] px-6 cursor-pointer py-2 rounded-md text-white font-semibold">
